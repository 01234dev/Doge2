...
built Dogecoin2 Core deployments.
...
3. The feature shall call the `DOGECOIN2_REQUIRE_EXPERIMENTAL` macro in
...
5. Inside each experimental code block, a call shall be made to the
   `DOGECOIN2_REQUIRE_EXPERIMENTAL` macro from `support/experimental.h`, to
