...
void Shutdown()
{
    ...
    RenameThread("dogecoin2-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Dogecoin2 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/LivingLitecoin/Doge2>";
    const std::string URL_WEBSITE = "<https://doge2.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("dogecoin2-loadblk");
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Dogecoin2: Do we need to do any RPC mining init here?
