...
// Dogecoin2: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateDogecoin2NextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetDogecoin2BlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{
