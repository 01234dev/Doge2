...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Dogecoin2: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Dogecoin2 (as there is no actual maximum coins)
