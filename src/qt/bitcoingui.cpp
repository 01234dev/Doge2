    ...
    platformStyle(_platformStyle)
{
    ...
    // Dogecoin2: load fallback font in case Comic Sans is not available on the system
    ...
    // Dogecoin2: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // Dogecoin2: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Dogecoin2: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dogecoin2 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dogecoin2: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dogecoin2 addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dogecoin2 addresses"));
    ...
    openAction->setStatusTip(tr("Open a dogecoin2: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a Dogecoin2 private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Dogecoin2 command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Dogecoin2 network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Dogecoin2"); // default title
