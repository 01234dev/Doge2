...
#define QAPP_ORG_NAME "Dogecoin2"
#define QAPP_ORG_DOMAIN "dogecoin2.org"
#define QAPP_APP_NAME_DEFAULT "Dogecoin2-Qt"
#define QAPP_APP_NAME_TESTNET "Dogecoin2-Qt-testnet"
