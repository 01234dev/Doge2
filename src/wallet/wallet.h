...
/* 1.14.5: set the wallet's discard threshold to 1 DC2 because that's what 97%
 ...
 */
/* 1.14.6: set the wallet's discard threshold to 0.01 DC2. Very network
...
/*
 * Dogecoin2: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * Dogecoin2: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * Dogecoin2: Get a fee targetting a specific transaction speed.
     */
    CAmount GetDogecoin2PriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed);
    /**
     * Dogecoin2: Get a fee targetting a specific transaction speed.
     */
    static CAmount GetDogecoin2PriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed, CAmount targetFee);
    /**
    ...
    /**
     * Return the minimum required fee taking into account the
     * floating relay fee and user set minimum transaction fee, but not the Dogecoin2 dust fee.
     */
