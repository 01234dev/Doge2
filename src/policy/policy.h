 ...
 *
 *  Dogecoin2:    Increment mempool limits and accept RBF in steps of 0.0001 DC2
...
/**
 * Dogecoin2: Default dust limit that is evaluated when considering whether a
...
/**
 * Dogecoin2: Default hard dust limit that is evaluated when considering whether
