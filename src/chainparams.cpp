...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 1; // 1 of 1
        consensus.nMinerConfirmationWindow = 1; // 1 block window
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL; // Disabled

        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00"); // 5,050,000

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00"); // 5,050,000

        // AuxPoW parameters
        consensus.nAuxpowChainId = 0x1d37; // 98 - Josh Wise!
        consensus.fStrictChainId = true;
        consensus.fAllowLegacyBlocks = true;
        consensus.nHeightEffective = 0;

        // Blocks 300+ use Digishield difficulty and simplified rewards in this fork
        digishieldConsensus = consensus;
        digishieldConsensus.nHeightEffective = 300;
        ...
        genesis = CreateGenesisBlock("Dogecoin 2 est 4-11-2026 Crypto2.0 is here to stay", CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG, 1775882778, 198256, 0x1e0ffff0, 1, 10000 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0xbb33a54cb7c21d06d384b457f63729707aad69b2a562b046ffdccaa9b5bbcc75"));
        assert(genesis.hashMerkleRoot == uint256S("0xa2a1af26f0eba1ec0accc3b71db339a1d7192265b0e18f6242826b09fac05fd8"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("doge2.org", "Doge1.doge2.org", true));
        vSeeds.push_back(CDNSSeedData("doge2.org", "Doge2.doge2.org"));
        vSeeds.push_back(CDNSSeedData("doge2.org", "Doge3.doge2.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (      0, uint256S("0xbb33a54cb7c21d06d384b457f63729707aad69b2a562b046ffdccaa9b5bbcc75"))
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("doge2.org", "testseed.doge2.org"));
