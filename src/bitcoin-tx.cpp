...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dogecoin2-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dogecoin2-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dogecoin2 transaction") + "\n" +
              "  dogecoin2-tx [options] -create [commands]   " + _("Create hex-encoded dogecoin2 transaction") + "\n" +
              "\n";
