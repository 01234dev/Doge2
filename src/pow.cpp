...
bool AllowMinDifficultyForBlock(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Dogecoin2: Magic number at which reset protocol switches
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Dogecoin2: Special rules for minimum difficulty blocks with Digishield
    ...
    bool fNewDifficultyProtocol = (pindexLast->nHeight >= 299);
    ...
    return CalculateDogecoin2NextWorkRequired(pindexLast, pindexFirst->GetBlockTime(), params);
}
