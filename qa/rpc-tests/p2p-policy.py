...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a Dogecoin2 Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in DC2
        ten = Decimal("10.0")                  # uniform 10 DC2 seed moneys
        ...
        # create a bunch of UTXO with seed money from the Dogecoin2 Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 DC2 output and 1 DC2 fee
    ...
    # spend seed money with a key not in the Dogecoin2 Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using Dogecoin2 Core raw tx APIs
        ...
        # and send the tx from there rather than from Dogecoin2 Core, to test
