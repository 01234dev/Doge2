# Contributing to Dogecoin2 Core

Dogecoin2 Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/LivingLitecoin/Doge2/labels/help%20wanted)
* [Projects](https://
...
````````````````/projects)
* [Dogecoin2dev on reddit](https://www.reddit.com/r/dogecoin2dev/)

## Branch Strategy

Dogecoin2 Core's default branch is intentionally a stable release, so that anyone
...
Dogecoin2 Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Dogecoin2 Core
releases will automatically benefit from these.

When refactoring Dogecoin2-specific code, please keep refactoring requests short,
...
The following applies to code changes to Dogecoin2 Core, and is not to be
confused with overall Dogecoin2 Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Dogecoin2 Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Dogecoin2; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Dogecoin2
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Dogecoin2 consensus, it must have been
